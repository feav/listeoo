...
\*******************************************************************/
	...
	{		
		header ("Location: https://cashbackholic.ro");
		exit();
	}
	...
	?>
			...
			<div class="row">
					...
					<!-- 	<div class="info_links" style="width: 100%; margin-top: 10px">
							<a class="favorites" href="<?php echo SITE_URL; ?>myfavorites/?act=add&id=<?php echo $row['retailer_id']; ?>"><?php echo CBE1_ADD_FAVORITES; ?></a>
							<a class="report" href="<?php echo SITE_URL; ?>report_retailer/?id=<?php echo $row['retailer_id']; ?>"><?php echo CBE1_REPORT; ?></a>
							<?php if (SUBMIT_COUPONS == 1) { ?>
								<a class="submit_coupon" href="<?php echo SITE_URL; ?>submit_coupon/?id=<?php echo $row['retailer_id']; ?>"><?php echo CBE1_STORE_COUPONS2; ?></a>
							<?php } ?> -->
							<br/><br/><br/>
							<p>
							<?php if (isset($_SESSION['userid'])) { ?>
								<a class="go2store_large" href="<?php echo SITE_URL; ?>go2store.php?id=<?php echo $row['retailer_id']; ?>" target="_blank"><?php echo 'Mergi la cumpărături'; ?></a>
							<?php }else{ ?>
