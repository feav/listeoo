...
<head>
	...
	<meta name="author" content="Adrian Clipotă" />
	<meta name="robots" content="index, follow" />
	<link href="https://fonts.googleapis.com/css?family=Open+Sans+Condensed:400,700" rel="stylesheet" type="text/css" />
    <link href="<?php echo SITE_URL; ?>css/bootstrap.min.css" rel="stylesheet" />
    <meta name='profitshareid' content='04a0317e5f4bbc26bfdb49a137157c91' />
	<!--[if lt IE 9]>
          ...
          <div class="row">
            ...
            <div id="custom-search-input">
                <div class="input-group col-md-12">
                    <input type="text" onkeypress="ajaxsearch(this.value)" id="searchtext" name="searchtext" class="form-control input-lg" value="<?php echo @$stext; ?>" placeholder="Cauta Magazine" />
            ...
            <div class="searchhere"></div>
			 ...
			 <?php if (isLoggedIn()) { ?>
					<?php echo CBE_WELCOME; ?>, <span class="member"><b><?php echo $_SESSION['FirstName']; ?></b></span> | <?php echo CBE_BALANCE; ?>: <span class="mbalance"><?php echo GetUserBalance($_SESSION['userid']); ?></span> | <?php echo CBE_REFERRALS; ?>: <a href="<?php echo SITE_URL; ?>invite/" style="color: #000"><span class="referrals"><?php echo GetReferralsTotal($_SESSION['userid']); ?></span></a><!-- | <a class="logout" href="<?php echo SITE_URL; ?>logout.php"><?php echo CBE_LOGOUT; ?></a>-->
  ...
  <nav class="navbar navbar-default" style="background-color: transparent; border: none;">
    ...
    <div class="collapse navbar-collapse js-navbar-collapse">
      <ul class="nav navbar-nav">
 			<li><a href="<?php echo SITE_URL; ?>" class="home">CashbackHolic</a></li>
			...
			<!--<li><a href="<?php echo SITE_URL; ?>myaccount.php" rel="nofollow">Contul Meu</a></li>-->
