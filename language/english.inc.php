...
/* HEADER MENU */
define ('CBE_MENU_HOME', 'Acasa');
define ('CBE_MENU_STORES', 'Magazine');
define ('CBE_MENU_COUPONS', 'Cupoane');
define ('CBE_MENU_FEATURED', 'Recomandari');
define ('CBE_MENU_ACCOUNT', 'Contul meu');
define ('CBE_MENU_FAVORITES', 'Favorite');
define ('CBE_MENU_HOW', 'Cum functioneaza');
define ('CBE_MENU_HELP', 'Help');
define ('CBE_SIGNUP', 'Inregistrare');
define ('CBE_LOGIN', 'Logare');
define ('CBE_SEARCH_MSG', 'Cauta magazine...');
define ('CBE_WELCOME', 'Bine ai venit');
define ('CBE_ACCOUNT', 'Contul meu');
define ('CBE_BALANCE', 'Cashback');
...
define ('CBE1_POINTS', 'puncte');
define ('CBE1_SCOUNTRIES', 'Only for users from');
define ('CBE1_CONDITIONS', 'Conditii');
define ('CBE1_ADD_FAVORITES', 'Adauga la favorite');
define ('CBE1_REPORT', 'Raporteaza');
define ('CBE1_GO_TO_STORE', 'Acceseaza magazinul');
define ('CBE1_GO_TO_STORE2', 'Acceseaza magazinul si castiga cashback');
define ('CBE1_SORT_BY', 'Sorteaza');
define ('CBE1_SORT_NAME', 'Nume');
define ('CBE1_SORT_POPULARITY', 'Popularitate');
define ('CBE1_SORT_DATE', 'Cele mai noi');
define ('CBE1_SORT_CASHBACK', 'Cashback');
define ('CBE1_RESULTS', 'Rezultate');
define ('CBE1_RESULTS_ALL', 'Toate');
define ('CBE1_RESULTS_SHOWING', 'Afiseaza');
define ('CBE1_RESULTS_OF', 'din');
define ('CBE1_SORT_ASC', 'Ascendent');
define ('CBE1_SORT_DESC', 'Descendent');
...
/* HOME */
define ('CBE1_HOME_FEATURED_STORES', 'Recomandari');
define ('CBE1_HOME_TOP_COUPONS', 'Top cupoane');
define ('CBE1_HOME_RECENT_REVIEWS', 'Recenzii');


/* BOXES */
define ('CBE1_BOX_ACCOUNT', 'Contul meu');
define ('CBE1_BOX_LOGIN', 'Logare');
define ('CBE1_BOX_SBS', 'Shop by Store');
define ('CBE1_BOX_SBS_SELECT', '- Cauta %total% magazine -');
define ('CBE1_BOX_SBC', 'Shop by Category');
define ('CBE1_BOX_ALLSTORES', 'Toate magazinele');
define ('CBE1_BOX_STATS', 'Statistici');
define ('CBE1_BOX_STATS_TITLE1', 'Toate magazinele');
define ('CBE1_BOX_STATS_TITLE2', 'Toate cupoanele');
define ('CBE1_BOX_STATS_TITLE3', 'Totii membri');
define ('CBE1_BOX_STATS_TITLE4', 'Membri platiti');
define ('CBE1_BOX_SOW', 'Magazinul saptamanii');
define ('CBE1_BOX_POPULAR', 'Popular');
define ('CBE1_BOX_BROWSE', 'Cauta dupa titlu');
define ('CBE1_BOX_NEW', 'Magazine noi');
define ('CBE1_BOX_NEW_MORE', 'mai mult...');
define ('CBE1_BOX_FOLLOW', 'Social Media');


/* FOOTER */
define ('CBE1_FMENU_ABOUT', 'Despre noi');
define ('CBE1_FMENU_NEWS', 'Blog');
define ('CBE1_FMENU_TERMS', 'Termeni si conditii');
define ('CBE1_FMENU_PRIVACY', 'Politica de confidentialitate');
define ('CBE1_FMENU_CONTACT', 'Contacteaza-ne');
define ('CBE1_FMENU_RSS', 'RSS Feed');
define ('CBE1_FMENU_RIGHTS', 'Toate drepturile rezervate');
...
/* SIGNUP */
define ('CBE1_SIGNUP_TITLE', 'Inregistrare');
define ('CBE1_SIGNUP_MEMBER', 'Esti deja membru?');
define ('CBE1_SIGNUP_LOGIN', 'Logare aici');
define ('CBE1_SIGNUP_ERR', 'Toate campurile trebuie completate');
define ('CBE1_SIGNUP_ERR2', 'Completeaza codul de securitate');
define ('CBE1_SIGNUP_ERR3', 'Cod CAPTCHA invalid');
define ('CBE1_SIGNUP_ERR4', 'Adresa e-mail invalida.');
define ('CBE1_SIGNUP_ERR5', 'Adresa de e-mail nu corespunde');
define ('CBE1_SIGNUP_ERR6', 'Confirmarea parolei nu corespunde');
define ('CBE1_SIGNUP_ERR7', 'Parola trebuie sa fie intre 6-20 caractere (litere si numere)');
define ('CBE1_SIGNUP_ERR8', 'Parola nu trebuie sa contina spatii');
define ('CBE1_SIGNUP_ERR9', 'Termenii si conditiile trebuie acceptati.');
define ('CBE1_SIGNUP_ERR10', 'Adresa de email este deja inregistrata.');
define ('CBE1_SIGNUP_PTEXT', '6-20 caractere');
define ('CBE1_SIGNUP_REG_SOURCE', 'Cum ai auzit de cashbackholic?');
define ('CBE1_SIGNUP_SCODE', 'Cod de securitate');
define ('CBE1_SIGNUP_RIMG', 'Refresh image');
define ('CBE1_SIGNUP_NEWSLETTER', 'I\'d aboneaza-ma la newsletter (Trimitem doar cele mai tari oferte)');
define ('CBE1_SIGNUP_AGREE', 'Sunt de acord cu');
define ('CBE1_SIGNUP_TERMS', 'Termenii si conditiile');
define ('CBE1_SIGNUP_BUTTON', 'Inregistrare');


/* LOGIN */
define ('CBE1_LOGIN_TITLE', 'Log in');
define ('CBE1_LOGIN_ERR', 'Introdu adresa de e-mail si parola');
define ('CBE1_LOGIN_ERR1', 'Adresa de e-mail sau parola invalida');
...
define ('CBE1_LOGIN_ERR3', 'Trebuie sa te loghezi');
define ('CBE1_LOGIN_ERR4', 'Trebuie sa fii logat pentru a castiga cashback');
define ('CBE1_LOGIN_ERR6', 'You account has been blocked. For more information please <a href="'.SITE_URL.'contact.php">contact us</a>');
define ('CBE1_LOGIN_ATTEMPTS', 'Incercari ramase');
define ('CBE1_LOGIN_EMAIL', 'Adresa email');
define ('CBE1_LOGIN_EMAIL2', 'Email');
define ('CBE1_LOGIN_PASSWORD', 'Parola');
define ('CBE1_LOGIN_REMEMBER', 'Remember me');
define ('CBE1_LOGIN_FORGOT', 'Ai uitat parola?');
define ('CBE1_LOGIN_NOT_MEMBER', 'Nu ai inca cont?');
define ('CBE1_LOGIN_BUTTON', 'Login');
define ('CBE1_LOGIN_AEMAIL', 'Nu ai primit email de confirmare?');
define ('CBE1_LOGIN_NMEMBER', 'Nu ai inca cont?');
define ('CBE1_LOGIN_TEXT2', 'Fa-ti cont si castiga cashback, este 100% gratuit!');
define ('CBE1_LOGIN_THX', 'Nu multumesc, du-ma spre magazin');
define ('CBE1_LOGIN_CONTINUE', 'Continua fara a castiga cashback');
define ('CBE1_LOGIN_TXT1', 'De ce sa alegi %site_title%?');
define ('CBE1_LOGIN_LI1', 'Gratuit!');
define ('CBE1_LOGIN_LI2', '<b>%amount%</b> bonus la inregistrare');
define ('CBE1_LOGIN_LI3', 'Refer your friends earn <b>%amount%</b> each');
define ('CBE1_LOGIN_LI4', 'Castiga pana la <b>35%</b> oferte cashback');
define ('CBE1_LOGIN_LI5', 'Cu ajutorul cupoanelor economisesti mai mult');
define ('CBE1_LOGIN_LI6', 'Cumpara online la magazinele tale favorite');


/* COUPONS */
define ('CBE1_COUPONS_TITLE', 'Coupons');
define ('CBE1_COUPONS_ALL', 'ALL COUPONS');
define ('CBE1_COUPONS_POPULAR', 'MOST POPULAR');
define ('CBE1_COUPONS_EXCLUSIVE', 'EXCLUSIVE');
define ('CBE1_COUPONS_LATEST', 'LATEST');
define ('CBE1_COUPONS_EXPIRING', 'EXPIRING SOON');
define ('CBE1_COUPONS_SDATE', 'Newest');
define ('CBE1_COUPONS_SPOPULAR', 'Popularity');
define ('CBE1_COUPONS_SSTORE', 'Store');
define ('CBE1_COUPONS_SEND', 'End Soonest');
define ('CBE1_COUPONS_TUSED', 'times used');
define ('CBE1_COUPONS_SEEALL', 'View all coupons');
define ('CBE1_COUPONS_CODE', 'Coupon code');
define ('CBE1_COUPONS_CODE_HIDDEN', 'LOGIN TO VIEW CODE');
define ('CBE1_COUPONS_LINK', 'Use Coupon');
define ('CBE1_COUPONS_LINK2', 'Get Deal');
define ('CBE1_COUPONS_MSG', 'Double-click on the code, hit Ctrl + C to copy to clipboard, then Use Coupon.');
define ('CBE1_COUPONS_EXCLUSIVE', 'Exclusive Coupon');
define ('CBE1_COUPONS_EXPIRES', 'Expires');
define ('CBE1_COUPONS_ENDED', 'Ended');
define ('CBE1_COUPONS_TIMELEFT', 'Time Left');
define ('CBE1_COUPONS_NO', 'There are no coupons at this time.');
define ('CBE1_COUPONS_BYSTORE', 'Coupons by Store');


/* SUBMIT COUPON */
define ('CBE1_SCOUPON_TITLE', 'Submit a Coupon');
define ('CBE1_SCOUPON_TEXT', 'Submit a coupon you\'ve found.');
define ('CBE1_SCOUPON_STORE', 'Store');
define ('CBE1_SCOUPON_STORE_SELECT', '-- select store --');
define ('CBE1_SCOUPON_TYPE', 'Offer Type');
define ('CBE1_SCOUPON_TYPE1', 'Coupon Code');
define ('CBE1_SCOUPON_TYPE2', 'Printable Coupon');
define ('CBE1_SCOUPON_TYPE3', 'Online Discount/Sale');
define ('CBE1_SCOUPON_LINK', 'Offer Link');
define ('CBE1_SCOUPON_NAME', 'Title');
define ('CBE1_SCOUPON_CODE', 'Code');
define ('CBE1_SCOUPON_EXPIRY', 'Expiry Date');
define ('CBE1_SCOUPON_EXPIRY_MM', 'mm');
define ('CBE1_SCOUPON_EXPIRY_DD', 'dd');
define ('CBE1_SCOUPON_EXPIRY_YYYY', 'yyyy');
define ('CBE1_SCOUPON_DESCRIPTION', 'Describe the offer...');
define ('CBE1_SCOUPON_ERR1', 'Please fill in all required fields');
define ('CBE1_SCOUPON_ERR2', 'Sorry, this coupon code is exists');
define ('CBE1_SCOUPON_ERR3', 'That coupon end date has already passed. Please enter a date in the future.');
define ('CBE1_SCOUPON_ERR4', 'Please enter coupon code');
define ('CBE1_SCOUPON_ERR5', 'Please enter coupon link');
define ('CBE1_SCOUPON_SENT', 'Thank you! Your coupon has been sent to us.');


/* REPORT STORE */
define ('CBE1_REPORT_TITLE', 'Report Store');
define ('CBE1_REPORT_TEXT', 'Incorrect info or broken link? Please let us know.');
define ('CBE1_REPORT_ERR1', 'Please describe the problem');
define ('CBE1_REPORT_ERR2', 'You have currently reported for this retailer');
define ('CBE1_REPORT_SENT', 'Thank you! Your report has been sent to us.');
define ('CBE1_REPORT_NO', 'Sorry, no store found!');


/* REDIRECT STORE */
define ('CBE1_REPORT_TITLE', 'Report Store');
define ('CBE1_REDIRECT_TEXT', 'One moment please...');
define ('CBE1_REDIRECT_TEXT1', 'Redirecting you to');
define ('CBE1_REDIRECT_TEXT2', 'you are on your way to earning');
define ('CBE1_REDIRECT_TEXT3', 'up to');
define ('CBE1_REDIRECT_TEXT4', 'at');
define ('CBE1_REDIRECT_TEXT5', '<a href="%url%">Click here</a> if you are not automatically redirected within 3 seconds.');
...
define ('CBE1_MYREVIEWS_STORE', 'Store');
...
/* MY SUPPORT */
define ('CBE1_MYMESSAGES_TITLE', 'Members Support');
define ('CBE1_MYMESSAGES_TEXT', 'Get your questions answered! Please fill form below and we\'ll be happy to help you as soon as possible.');
define ('CBE1_MYMESSAGES_ERR1', 'Please enter your message');
define ('CBE1_MYMESSAGES_ERR2', 'Please fill in all fields');
define ('CBE1_MYMESSAGES_SENT', 'Your message has been sent. We will get back to you as soon as possible.');
define ('CBE1_MYMESSAGES_SUBJECT', 'Subject');
define ('CBE1_MYMESSAGES_DATE', 'Date');
define ('CBE1_MYMESSAGES_REPLIES', 'Replies');
define ('CBE1_MYMESSAGES_ACTIONS', 'Actions');
define ('CBE1_MYMESSAGES_ADMIN', 'Support');
define ('CBE1_MYMESSAGES_VIEW', 'View');
define ('CBE1_MYMESSAGES_MESSAGE', 'Message');
define ('CBE1_MYMESSAGES_BUTTON', 'Send Message');
define ('CBE1_MYMESSAGES_TITLE2', 'My Messages');
define ('CBE1_MYMESSAGES_REPLY', 'Reply');
define ('CBE1_MYMESSAGES_REPLY_BUTTON', 'Reply');
define ('CBE1_MYMESSAGES_TITLE2', 'My Messages');
define ('CBE1_MYMESSAGES_NO', 'There are no messages at this time.');
...
define ('CBE1_ACCOUNT_INVITE', 'Refer a Friend');
...
/* CLICK HISTORY */
define ('CBE1_CLICK_TITLE', 'Click History');
define ('CBE1_CLICK_TEXT', 'Below you will find the list of latest stores you\'ve visited. So you can track the stores you have looked at.');
define ('CBE1_CLICK_STORE', 'Store');
define ('CBE1_CLICK_ID', 'Reference ID');
define ('CBE1_CLICK_DATE', 'Date');
define ('CBE1_CLICK_VISITS', 'visits');
define ('CBE1_CLICK_LAST_VISIT', 'Last Visit');
define ('CBE1_CLICK_GOSTORE', 'Go to Store');
define ('CBE1_CLICK_NO', 'There are no clicks at this time.');
...
/* MY FAVORITE STORES */
define ('CBE1_MYFAVORITES_TITLE', 'My Favorite Stores');
define ('CBE1_MYFAVORITES_TEXT', 'Below you will find all your favorite stores.');
define ('CBE1_MYFAVORITES_MSG1', 'Store has been added to your favorites!');
define ('CBE1_MYFAVORITES_MSG2', 'Store has been deleted from your favorites!');
define ('CBE1_MYFAVORITES_NO', 'You do not have favorite stores at this time.');
define ('CBE1_MYFAVORITES_DELETE', 'Are you sure you really want to delete this store from your favorites?');
define ('CBE1_MYFAVORITES_DEL', 'Delete');
define ('CBE1_MYFAVORITES_ADD', 'Add Stores to Your Favorites');
...
define ('CBE1_BREADCRUMBS_STORES', 'Stores');
...
/* STORES */
define ('CBE1_STORES_STORES', 'Stores');
define ('CBE1_STORES_ALL', 'All');
define ('CBE1_STORES_CNO', 'Category not found');
define ('CBE1_FEATURED_STORE', 'Featured Store');
define ('CBE1_STORES_FEATURED', 'Featured Stores');
define ('CBE1_STORES_NAME', 'Store Name');
define ('CBE1_STORES_COUPONS', 'Coupons');
...
define ('CBE1_STORE_STORES', 'Store');
define ('CBE1_STORE_EARN', 'Earn up to');
define ('CBE1_STORE_ALL', 'All');
define ('CBE1_STORE_STATS', 'Statistics');
define ('CBE1_STORE_COUPONS', 'Coupons');
define ('CBE1_STORE_COUPONS1', 'coupons');
define ('CBE1_STORE_COUPONS2', 'Submit a Coupon');
...
define ('CBE1_REVIEW_SENT', 'Thank you. Your review has been submitted and is awaiting approval.');
...
define ('CBE1_FORGOT_TEXT', 'Please enter your email address below and we will send you an email that contains your new password.');
...
/* FEATURES RETAILERS */
define ('CBE1_FEATURED_TITLE', 'Featured Offers');
define ('CBE1_FEATURED_TEXT', 'We always get asked what are the best of the best stores that we recommend to our members. Below are the top stores from each of our categories hand-picked by our expert team.');
define ('CBE1_FEATURED_NO', 'There are no featured stores at this time.');
